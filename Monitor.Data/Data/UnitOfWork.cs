...
#elif TESTDB
        public static readonly string DB1 = @"Data Source=192.168.8.33;Initial Catalog=AmkorK3_AMB; User ID = sa; Password=acsserver;Connect Timeout=30;";
        public static readonly string DB2 = @"Data Source=192.168.8.33;Initial Catalog=AmkorK3_AMB; User ID = sa; Password=acsserver;Connect Timeout=30;";
        public static readonly string DB3 = @"Data Source=192.168.8.33;Initial Catalog=AmkorK3_User_Data; User ID = sa; Password=acsserver;Connect Timeout=30;";
#else
        // ACS PC만 연결
